package com.harunkor.mvvmsamplejava.adapter;
...
import com.harunkor.mvvmsamplejava.R;
import com.harunkor.mvvmsamplejava.model.Volume;
...
public class BookSearchResultsAdapter extends RecyclerView.Adapter<BookSearchResultsAdapter.BookSearchResultHolder> {
    ...
    public void onBindViewHolder(@NonNull BookSearchResultHolder holder, int position) {
        ...
        holder.publishedDateTextView.setText(volume.getVolumeInfo().getPublishDate());
